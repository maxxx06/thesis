...
\begin{block}{What is a dynamic version of the FBA}
FBA is solved at each time step.
\end{block}

\only<1>{
\begin{minipage}{0.5\textwidth}
\begin{tikzpicture}
   \node (x) [circle, draw] at (0,0)   {Xe};
   \node (a) [circle, draw,fill=white!60!yellow] at (2,0)   {A};
   \node (b) [circle, draw,fill=white!60!yellow] at (4,0)   {C};
   \node (c) [circle, draw,fill=white!60!yellow] at (3,1)   {D};
   \node (d) [circle, draw,fill=white!60!yellow] at (5,-1)   {E};
   \node (e) [circle, draw,fill=white!60!yellow] at (3.5,-2)   {F};
      \node (fe) [circle, draw] at (3.5,-3)   {Fe};
          
    \node (f) [rectangle, draw,fill=white!60!yellow] at (1,0) {$r_1$};
  	\node (g) [rectangle, draw,fill=white!60!yellow] at (3,0)  {$r_2$};
  	\node (h) [rectangle, draw,fill=white!60!yellow] at (5,0)   {$r_3$};
  	\node (i) [rectangle, draw,fill=white!60!yellow] at (4,-1)   {$r_4$};
  	\node (j) [rectangle, draw,fill=white!60!yellow] at (5,-2)   {$r_5$};
...
\begin{minipage}{0.4\textwidth}
\begin{itemize}
\item Intracellular dynamics are faster than the extracellular dynamics $\rightarrow$ Steady-state assumption\tiny\citep{DEOLIVEIRA2023108101}
\end{itemize}
\end{minipage}
}
...
\begin{minipage}{0.5\textwidth}
\begin{tikzpicture}
   \node (x) [circle, draw,fill=white!60!yellow] at (0,0)   {Xe};
   \node (a) [circle, draw] at (2,0)   {A};
   \node (b) [circle, draw] at (4,0)   {C};
   \node (c) [circle, draw] at (3,1)   {D};
   \node (d) [circle, draw] at (5,-1)   {E};
   \node (e) [circle, draw] at (3.5,-2)   {F};
      \node (fe) [circle, draw,fill=white!60!yellow] at (3.5,-3)  {Fe};
...
\item Intracellular dynamics are faster than the extracellular dynamics $\rightarrow$ Steady-state assumption\tiny\citep{DEOLIVEIRA2023108101}
\vspace{0.5cm}
\item  \normalsize Apply mass balance equations to describe the behavior of the extracellular metabolites \tiny\citep{DEOLIVEIRA2023108101}
\end{itemize}
\end{minipage}
...
\begin{frame}
\frametitle{Objectif of the individual metabolic model calibration}
...
\begin{minipage}{0.5\textwidth}
\begin{figure}
\includegraphics[width=\textwidth]{figures/ind-data-plantarum.pdf}
\end{figure}
\end{minipage}%
\begin{minipage}{0.5\textwidth}
\includegraphics[width=\textwidth]{figures/ph-data-lactis.pdf}
\end{minipage}%

\begin{block}{}
\begin{itemize}
\item Without adding extra nutrient
\item Experimental and simulated data must fit
\end{itemize}
\end{block}
}
...
%\begin{minipage}{0.5\textwidth}
%\begin{figure}
%\includegraphics[width=0.7\textwidth]{figures/ind-data-plantarum.pdf}
%\end{figure}
%\end{minipage}%
%\begin{minipage}{0.5\textwidth}
\begin{table}[H]
...
\end{tabular}
\end{adjustbox}
\caption{Acids data in g/L}
\label{table:acids-dosage}
\end{table}

\begin{block}{}
\begin{itemize}
\item Adding lactate in the nutritional environment
\item Experimental and simulated data must fit
\end{itemize}
\end{block}
}
...
\item added-value of adding species 
\end{itemize}
\end{block}
\end{minipage}%
\hspace{0.5cm}
